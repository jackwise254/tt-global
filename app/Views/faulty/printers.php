...
<div class="py-2 mt-2">
      ...
      <!-- spreadsheet -->
      <a href="<?php echo site_url('spreadsheetfp') ?>" class="btn btn-info btn-sm bi bi-download">spreadsheet</a>
                    ...
                    <table class="table table-fixed table-striped " style='font-family:"Airal", Arial, Arial; font-size:60%'>
                        ...
                        <tbody>
                            ...
                            <td class="">  
                              ...
                              <a href="<?php echo base_url('ProductsCrud/okf/'.$user->assetid);?>" class='px-2'>[Spoiled]</a>
