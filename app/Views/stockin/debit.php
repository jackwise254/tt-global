...
<div class="py-2 mt-2">
      ...
      <!-- spreadsheet -->
      <a href="<?php echo site_url('spreadsheetd') ?>" class="btn btn-info btn-sm bi bi-download">spreadsheet</a>
                    ...
                    <table class="table table-fixed table-striped " style='font-family:"Airal", Arial, Arial; font-size:60%'>
                        ...
                        <tbody>
                            ...
                            <td class="">  
                              ...
                              <a href="<?= base_url('ProductsCrud/printbarcodd/'.$user->assetid) ?>" class="px-2">[barcode]</a> 
                              <a href="<?= base_url('ProductsCrud/printbarcode2d/'.$user->assetid ) ?>" class="px-2">[barcode2]</a> 
