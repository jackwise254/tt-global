...
<div class="py-2 mt-2">
      <br/> <br/>
      <div class="my-3">
      <a href="<?php echo site_url('warrantyout') ?>" class="btn btn-success btn-sm bi bi-chevron-left">back</a>
                    ...
                    <table class="table table-fixed table-striped " style='font-family:"Airal", Arial, Arial; font-size:50%'>
                        ...
                        <tbody>
                            ...
                            <td class="">  
                              ...
                              <a href="<?php echo base_url('ProductsCrud/singleProduct/'.$user->id);?>" class='pr-2'>[Edit]</a>
                              <a href="<?php echo base_url('ProductsCrud/delete/'.$user->id);?> " class="pr-2" >[Del]</a>
                              <a href="<?= base_url('ProductsCrud/printbarcod/'.$user->assetid) ?>" class="">[barcode]</a> 
                            </div>
                            </td>
