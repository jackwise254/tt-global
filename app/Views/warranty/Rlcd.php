...
<div class="py-2 mt-2">
      ...
      <a href="<?php echo site_url('stock-view') ?>" class="btn btn-success btn-sm bi bi-chevron-left">back</a>
        <!-- spreadsheet -->
      <a href="<?php echo site_url('Rdesktopsp') ?>" class="btn btn-info btn-sm bi bi-download">spreadsheet</a>
                        ...
                        <tbody>
                            ...
                            <td class="">  
                              ...
                              <?php if($user_data == 'admin'):  ?>
                               ...
                               <?php endif; ?><a href="<?php echo base_url('ProductsCrud/singleProduct/'.$user->id);?>" class='px-2'>[Edit]</a>
