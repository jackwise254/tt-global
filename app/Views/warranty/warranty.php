...
<div class=" mt-5 pt-5">
  <h4 class="text-center"><u>Warranty In</u></h4>
      <div class="my-3">
      <a href="<?php echo site_url('warranty') ?>" class="btn btn-success btn-sm bi bi-chevron-left rounded-pill">back</a>
      <a href="<?php echo site_url('spreadsheetwi') ?>" class="btn btn-info btn-sm bi bi-download rounded-pill">spreadsheet</a>
     ...
     <?php endif; ?>
      <form class="d-flex float-end">
      <select class="form-select form-control w-75 d-inline rounded-pill"  name="customer" placeholder="customer" >
          ...
          <button class="btn btn-info rounded-pill btn-sm" type="submit">Search </button>
      </form>
      </div>
