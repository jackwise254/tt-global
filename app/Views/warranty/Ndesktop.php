...
<div class="py-2 mt-2">
 ...
 <!-- spreadsheet -->
      <a href="<?php echo site_url('spreadsheetwi') ?>" class="btn btn-info btn-sm bi bi-download">spreadsheet</a>
                                ...
                                <div class="modal-dialog modal-confirm">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <p>You are about to change the status to ok.</p>
                                        </div>
                                        <div class="modal-footer justify-content-center">
                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                                            <a href="<?php echo base_url('ProductsCrud/ok/'.$user->assetid);?> " class="" >[Ok]</a>
                              <a href="<?php echo base_url('ProductsCrud/fixed/'.$user->assetid);?>" class='px-2'>[Fixed]</a>
                            ...
                            <div id="myModal1" class="modal fade">
                                <div class="modal-dialog modal-confirm">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <p>You are about to change the status to fixed.</p>
                                        </div>
                                        <div class="modal-footer justify-content-center">
                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                                            <a href="<?php echo base_url('ProductsCrud/fixed/'.$user->assetid);?> " class="btn btn-success deletebtn" >fixed</a>
