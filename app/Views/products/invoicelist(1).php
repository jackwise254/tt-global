            ...
            <main>
                <div class="row contacts">
                    <div class="col invoice-to">
                        ...
                        <h2 class="to"><?php echo "string"; ?></h2>
                ...
                <table border="0" cellspacing="0" cellpadding="0">
                    <thead>
                        <tr>
                            ...
                            <th class="text-right"><?=  $user['speed']; ?></th>
                            <th class="text-right"><?=  $user['gen']; ?></th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            ...
                            <td class="text-right"><?=  $user['speed']; ?></td>
                            <td class="text-right"><?=  $user['gen']; ?></td>
                        </tr>
