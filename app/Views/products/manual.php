...
<?php echo $random = rand(10000, 99999); ?>
    ...
    <!-- <a href="<?php echo base_url('ProductsCrud/invoicePage') ?>" class="btn btn-light btn-sm bi bi-chevron-left">Back</a> -->
      
    <form name="test" class="mt-3" action="<?php echo  base_url('ProductsCrud/dsubm'); ?>" method="POST">
        <div class="row">
            <div class="col-md-4">
                
                <label style="font-family: arial, arial, arial; font-size: 13px ">Customer</label>
            ...
            <label style="font-family: arial, arial, arial; font-size: 13px ">Delivery_no:</label>
                <input type="text" class=" form-control" name="deliver" style="font-family: arial, arial, arial; font-size: 13px " placeholder="" required>
            </div>

            <div class="col-md-2">
        <a href="<?php echo base_url('ProductsCrud/delv') ?>" class="btn btn-warning btn-sm mt-4 float-end">Scan</a>

                    <button type ="submit" class="btn btn-success mt-4" style="font-family: arial, arial, arial; font-size: 13px ">Submit</button>
            </div>
        </div>
         ...
         <div class=" form-row">
            ...
            <h4 class="text-center" style="font-family: arial, arial, arial; font-size: 14px ">Customer details </h4>
                    ...
                    <div class="row px-3 ">
                        ...
                        <div class="col">
                        <label  class="col-sm-2 col-form-label " style="font-family: arial, arial, arial; font-size: 13px ">Sale_Order</label>
                        <input type="text" class="form-control mb-4" style="font-family: arial, arial, arial; font-size: 13px " name="Delivery_no" placeholder="<?=  $user->deliver; ?>" readonly>
                        </div>
...
<div class="container ">
        <div class=" form-row">
            ...
            <input class="form-control my-3 d-none" id="barcodeValue2" value="<?= $random; ?>" name="assetid">
                ...
                <form method="post" id="invoice_create" name="invoice_create" action="<?php echo base_url('ProductsCrud/delvstore'); ?>">
                <div class="row">
                  <div class="col-6">
                ...
                <form method="post" id="invoice_create" name="invoice_create" action="<?php echo base_url('ProductsCrud/mdelvout'); ?>">
                ...
                <h5 class="d-flex justify-content-end" style='font-family:"Airal", Arial, Arial; font-size:60%'><?php echo $count_invoice; ?> Item(s) added </h5>
                    <table class="table table-fixed table-striped " style='font-family:"Airal", Arial, Arial; font-size:60%'>
                        ...
                        <tbody>
                            ...
                            <a href="<?php echo base_url('ProductsCrud/ddeleted/'.$user->del);?> "  class="pr-2">[del]</a>
                        </div>
                            <td class="col-6"><?=  $user->description; ?></td>
                            <td class="col-3"><?=  $user->qty; ?></td>
                            <td class="col-3"><?=  $user->unitprice; ?></td>
