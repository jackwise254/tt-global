...
$_SESSION['deliver']=$item->deliver;
$_SESSION['delvnote']=$item->delvnote;
$_SESSION['username']=$item->username;
$_SESSION['vendor']=$item->lname;
$_SESSION['address']=$item->location;
...
function Header()
{
    ...
    $number = 'D-'.$_SESSION['delvnote'];
    $this->SetFont('Arial','',14);
    $this->Cell(7);
     $this->Cell(180,16,'Delivery Note',10,0,'C');
     $this->Ln(10);
    $this->SetFont('Arial','',11);
     $this->Cell(40,16,'Customer : '.$_SESSION['username'],10,0,'L');
    $this->Cell(140,16,'Date: '.$_SESSION['datedelivered'],10,0,'R');
     $this->Ln(10);
     $this->Cell(40,16,'Address : '.$_SESSION['address'],10,0,'L');
    $this->Cell(140,16,'Delivery no: '.$number,10,0,'R');
     $this->Ln(10);
     $this->Cell(40,16,'Reference: '.$_SESSION['deliver'],10,0,'L');
     $this->Ln(10);
     $this->Cell(27);
...
$pdf->AliasNbPages();
$pdf->AddPage();
$with_cell = array(10,15,20,30,40,50,180,140);
$pdf->SetFont('Times','',8);
...
if($desc1 != 'null'){$pdf->Cell($with_cell[7],7,$desc1,1,0,'L');}
