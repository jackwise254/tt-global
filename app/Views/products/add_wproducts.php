...
<form class="form-group " method="post" id="add_create" name="add_create" action="<?= site_url('/submit-wproducts') ?>">
<h4 class="text-center position-fixed w-75"><u>Warranty Upload.</u></h4>
