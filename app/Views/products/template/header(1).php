...
<body class="bg-ligt">
<nav class="navbar navbar-expand-lg navbar-light bg-secondary text-dark">
  <div class="container">
  ...
  <li class="nav-item">
     ...
     <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link text-light" href="<?php echo site_url('/techpanel') ?>">Tech Panel</a>
      </li>
      
    </ul>
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <div class="ms-auto float-end">
      <a href="<?php echo base_url('Login/logout') ?>" class="fa fa-user text-light" > Logout</a>
    </div>
  </div>
  </div>
</nav>
