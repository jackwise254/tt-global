...
<body class="bg-light container mt-5 p-5">
 ...
 <h4 class ='text-center position-fixed px-5'> Edit Faulty products </h4>
 ...
 <form method="post" id="update_user" autocomplete="off" name="update_user" 
                 action="<?= base_url('ProductsCrud/editRCVDf/'. $user_obj['del']) ?> ">
...
<div class="form-row pt-3">
    ...
    <tbody>
      ...
      <td>
    		...
    		<td>
    			<input type="text" class="form-control" name="vendor" value="<?php echo $user_obj['vendor']; ?>">
    		</td>
        <td>
