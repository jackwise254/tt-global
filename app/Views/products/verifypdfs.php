...
function Header()
{
    ...
    $this->Cell(7);
     //Title
     $this->Cell(40,16,'Verification document',10,0,'C');
     $this->Ln(10);
    $this->SetFont('Arial','',11);
     $this->Cell(40,16,'',10,0,'L');
     $this->Ln(10);
     $this->Cell(40,16,'',10,0,'L');
     $this->Ln(10);
...
$pdf->Cell($with_cell[0],7,$v->qty ,1,1,'L');
...
$sql = "INSERT INTO `vproduct` (ref, document) 
VALUES ( '$ref', '$namepdf')";
