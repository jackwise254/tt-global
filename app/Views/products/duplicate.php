...
<div class="py-2 mt-2">
      ...
      <button type="button" class="btn btn-secondary rounded-pill btn-sm position-relative me-2">
          Items
          ...
          <input class="form-control me-2 rounded-pill d-none" name="model" placeholder="Search model" aria-label="Search">
          <input class="form-control me-2 rounded-pill d-none" name="q" placeholder="Search" aria-label="Search">
          <button class="btn btn-info rounded-pill me-2 d-none btn-sm" type="submit">Search </button>
                ...
                <div class="table-responsive">
                    ...
                    <thead class="bg-primary text-light sticky-top">
                        ...
                        <tbody>
                            ...
                            <td cclass="col-3"><?=  $user['daterecieved']; ?></td>
                            <td cclass="col-3"><?=  $user['datedelivered']; ?></td>
