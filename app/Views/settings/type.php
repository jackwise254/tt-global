...
?>
 ...
 <h5 class="text-center"><u> Type</u></h5>
 <form name="test" action="<?php echo  base_url('Settings/Type'); ?>" method="POST">
<a href="<?php echo base_url('ProductsCrud/Setting') ?>" class="btn btn-dark btn-sm bi bi-chevron-left">back</a>

<label class=''>Type</label>
 <input type="text" class=" " id="type" name="type" required>
                    ...
                    <table class="table table-fixed table-striped " style='font-family:"Airal", Arial, Arial; font-size:50%'>
                        ...
                        <tbody>
                            ...
                            <td class="">  
                              ...
                              <a href="<?= base_url('Settings/deletet/'.$user->id);?>" class="btn-submit bi bi-file-x-fill btn btn-danger btn-sm"></a>
