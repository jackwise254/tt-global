...
?>
 ...
 <h5 class="text-center"><u> SCREEN SIZE</u></h5>
 <form name="test" action="<?php echo  base_url('Settings/Screen'); ?>" method="POST">
    ...
    <label class=''>Screen</label>
     <input type="text" class=" "  id="screen" name="screen" required>
                    ...
                    <table class="table table-fixed table-striped " style='font-family:"Airal", Arial, Arial; font-size:50%'>
                        ...
                        <tbody>
                            ...
                            <td class="">  
                              ...
                              <a href="<?= base_url('Settings/deletes/'.$user->id);?>" class="btn-submit bi bi-file-x-fill btn btn-danger btn-sm"></a>
