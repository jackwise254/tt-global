...
?>
 ...
 <h5 class="text-center"><u> HDD</u></h5>
 <?php
                    ...
                    <table class="table table-fixed table-striped " style='font-family:"Airal", Arial, Arial; font-size:50%'>
                        ...
                        <tbody>
                            ...
                            <td class="">  
                              ...
                              <a href="<?= base_url('Settings/deleteh/'.$user->id);?>" class="btn-submit bi bi-file-x-fill btn btn-danger btn-sm"></a>
