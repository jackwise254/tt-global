...
?>
 ...
 <div class="container mt-5 pt-5">
    <h5 class="text-center"><u> Conditions</u></h5>
 <?php
...
?>
 <form name="test" action="<?php echo  base_url('Settings/settings'); ?>" method="POST">
<a href="<?php echo base_url('ProductsCrud/Setting') ?>" class="btn btn-success btn-sm bi bi-chevron-left">back</a>

    <label >Condition.</label>
     <input type="text" class="" id="conditions" name="conditions" required>
                    ...
                    <table class="table table-fixed table-striped " style='font-family:"Airal", Arial, Arial; font-size:50%'>
                        ...
                        <tbody>
                            ...
                            <td class="">  
                              ...
                              <a href="<?= base_url('Settings/delete/'.$user->id);?>" class="btn-submit bi bi-file-x-fill btn btn-danger btn-sm"></a>
