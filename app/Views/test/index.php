...
<div class="py-2 mt-5 pt-4">
      ...
      <a href="<?php echo base_url('Settings/masterlistsums/'.$title) ?>" class="btn btn-outline-success btn-sm bi rounded-pill bi-download">Summary</a>
      <!-- <div class ='container'> -->
                    ...
                    <table class="table table-fixed table-striped " style='font-family:"Airal", Arial, Arial; font-size:60%'>
                        ...
                        <tbody>
                            ...
                            <div class="btn-group" role="group" aria-label="Basic example">
                              ...
                              <a href="<?= base_url('ProductsCrud/printbarcode2/'.$user->assetid ) ?>" class="px-2">[barcode2]</a> 
