...
<div class="py-2 mt-5 pt-4">
      ...
      <div class="my-3">
      <a href="<?php echo site_url('/warranty') ?>" class="btn btn-outline-success rounded-pill btn-sm bi bi-chevron-left">back</a>
      <a href="<?php echo base_url('Vendor/spreadsheetgnw/'.$title) ?>" class="btn btn-outline-primary rounded-pill btn-sm bi bi-download">spreadsheet</a>
      <a href="<?php echo base_url('Settings/warrantyinsum/'.$title) ?>" class="btn btn-outline-success btn-sm bi rounded-pill bi-download">Summary</a>
